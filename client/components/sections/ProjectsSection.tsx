    ...
    <section id="projects" className="relative py-20">
      <div className="absolute inset-0 -z-10 opacity-50 [mask-image:radial-gradient(60%_60%_at_50%_10%,black,transparent)]">
        <svg
          ...
          className="h-full w-full text-emerald-700/10"
        >
          <defs>
            <pattern
              id="network"
      ...
      <div className="container">
        ...
        <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {projects.map((p) => (
            <Card
              key={p.title}
              className="group border-emerald-800/10 bg-card/70 backdrop-blur-sm"
            >
              <CardHeader>
              ...
              <CardContent />
              <CardFooter>
                <Button className="group-hover:shadow-emerald-700/30 group-hover:shadow-lg">
                  Explore Project
                </Button>
              </CardFooter>
            </Card>
