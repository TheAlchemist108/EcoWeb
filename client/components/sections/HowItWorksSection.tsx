...
const items = [
  { icon: Scale, title: "Ethical by Design", text: "Fair, transparent models with human oversight." },
  { icon: Zap, title: "Energy Efficient", text: "Efficient coding and renewable-powered servers." },
  { icon: CircuitBoard, title: "Explainable & Open", text: "Explainable AI and open data where possible." },
];
